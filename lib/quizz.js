...
// next 4 sessions after it (i.e. only reusable again 5 sessions later).
// Persisted per chat so the cooldown survives across separate .quizz runs,
// not just within one - each chat keeps a rolling window of its last 5
// sessions' worth of questions.
