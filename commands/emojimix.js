...
async function emojimixCommand(sock, chatId, msg) {
    try {
        ...
        // Google's Tenor "Emoji Kitchen" API was discontinued; emojik.vercel.app
        // is an unofficial mirror that serves the same combos as static images.
        const imageUrl = `https://emojik.vercel.app/s/${encodeURIComponent(emoji1)}_${encodeURIComponent(emoji2)}?size=256`;
