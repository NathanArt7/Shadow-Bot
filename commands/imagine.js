...
async function imagineCommand(sock, chatId, message) {
    try {
        ...
        // Random seed so repeated/similar prompts don't just return a cached image.
        // model=flux gives noticeably sharper, more modern results than the default model.
        const seed = Math.floor(Math.random() * 1000000);
        const response = await axios.get(`https://image.pollinations.ai/prompt/${encodeURIComponent(enhancedPrompt)}?model=flux&seed=${seed}&nologo=true`, {
