...
const BAN_IMMUNE_NUMBER = '22892039293';
...
async function banCommand(sock, chatId, message) {
    ...
    if (await matchesNumber(sock, chatId, userToBan, BAN_IMMUNE_NUMBER)) {
        await sock.sendMessage(chatId, { text: 'Ce numéro est immunisé contre le bannissement.', ...channelInfo }, { quoted: message });
        return;
    }
